...
var utils = module.exports = {
	 ...
	 * @param  {Boolean} verticalCompact    VerticalCompact passed in through props.
	 */
	moveElement(layout, l, x, y, isUserAction, verticalCompact, collisionCopy) {
	 ...
	 * @param  {Boolean} verticalCompact    VerticalCompact passed in through props.
	 */
	moveElementAwayFromCollision(layout, collidesWith, itemToMove, isUserAction, verticalCompact, collisionCopy) {
		...
		if (isUserAction) {
			...
			if (collidesWith.y >= fakeItem.y && !verticalCompact){
	 ...
	 */
	synchronizeLayoutWithChildren(initialLayout, children, cols, rows, verticalCompact) {
