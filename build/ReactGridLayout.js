...
var ReactGridLayout = React.createClass({
  ...
  */
	...
	checkPreviousCollisions: function checkPreviousCollisions(layout) {
	...
	addNewCollisions: function addNewCollisions(newCollisions, oldCollisions) {
  ...
  */
	...
	render: function render() {
		...
		return React.createElement(
			'div',
			_extends({}, props, { className: className, style: { height: height, width: width } }),
